...
CRBootedReasons = {100: 'You have been disconnected because someone else just logged in using your account on another computer.',
 ...
 105: 'Toontown Sandbox is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the Toontown 2.0 website.',
 124: 'Your installed files are out of date!  Use the official launcher to download the newest version, or contact Toontown SandboxSupport if the problem persists.',
...
CRMaintenanceCountdownMessage = 'Attention Toons! Toontown Sandbox will be going down for maintenance in %d minutes.'
CRMaintenanceMessage = 'Attention Toons! Toontown Sandbox is now going down for maintenance.'
...
AsciiNotSupported = 'Sorry, but Toontown Sandbox does not support non-ASCII characters.'
AccessToString = {
