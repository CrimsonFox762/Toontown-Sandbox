...
AvatarPanelCastInfo = '%s is a Toontown Sandbox Cast Member.'
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'Legalese': ['You must cease and desist.',
              ...
              "The opinions expressed in this attack are not those of Toontown Sandbox.",
...
MusicTtTheme = 'The Toontown Sandbox Theme'
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'Press the "F9" key to take a screenshot, which will be saved in your Toontown Sandbox folder on your computer.',
               ...
               'You never need to save your Toontown progress. The Toontown Sandbox servers continually save all the necessary information.',
...
PolarPlaceEffect1 = NPCToonNames[3306] + ': Welcome to Penguin Place!'
...
FriendSecretIntro = "If you are playing Toontown Sandbox with someone you know in the real world, you can become True Friends. You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
